			  ...
			  <div class="panel-body">
				<form role="form" id="updateForm">
				  ...
				  <div class="form-group">
					...
					<input type="text" class="form-control" id="icon" name="icon" value="${permission.icon }" placeholder="请输入许可图标">
				  </div>
				  <div class="form-group">
					<label for="url">许可URL</label>
					<input type="text" class="form-control" id="url" placeholder="请输入许可URL" value="${permission.url }" name="url">
					<p class="help-block label label-warning">请输入许可URL</p>
				  </div>
				  <button type="button" class="btn btn-success" onclick="updatePermission()"><i class="glyphicon glyphicon-plus"></i> 修改</button>
