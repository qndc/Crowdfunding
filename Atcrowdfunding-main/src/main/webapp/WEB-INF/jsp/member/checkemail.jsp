      ...
      <div class="page-header">
		...
		<form role="form" style="margin-top:20px;">
		  <div class="form-group">
			...
			<input type="email" class="form-control" id="email" value="${member.email }" name="email" placeholder="请输入用于接收验证码的邮箱地址">
		  </div>
				...
				$.ajax({
					...
					success:function(result){
						...
						if (result.status == 200) {
							layer.confirm(result.message,{icon:1,title:'邮箱验证'},function(cindex){
								layer.close(cindex);
								window.location.href = "${APP_PATH}/member/tocheckcode.htm";
							})	
						}else {
