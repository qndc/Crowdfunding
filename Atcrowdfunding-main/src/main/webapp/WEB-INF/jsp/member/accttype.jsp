...
.seltype {
 ...
 <div class="navbar-wrapper">
    ...
    <div class="container theme-showcase" role="main">
      ...
      <h2>商业公司</h2>
        <a href="javascript:void(0)" class="thumbnail" accttype="0">
    ...
    //更新用户类型
        ...
        function toapply() {
        	...
        	if ($('.seltype').length == 0) {
				...
				$.ajax({
					url:"${APP_PATH}/member/toApply.do",
					type:"POST",
					data:{
						accttype:accttype
					},
					...
					error:function(result){
						layer.msg("修改账户类型失败！",{time:1000,icon:5,shift:6})
					}
				})
			}
		} 
