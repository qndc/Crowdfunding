 ...
 <div class="navbar-wrapper">
    ...
    <div class="container theme-showcase" role="main">
      <div class="page-header">
		...
		<form style="margin-top:20px;" method="POST" id="certForm" enctype="multipart/form-data">
		  <c:forEach items="${requestScope.certs }" var="cert" varStatus="status">
		  	<div class="form-group">
				<label for="exampleInputEmail1">${cert.name }</label>
					<input type="hidden" name="list[${status.index}].certid" value="${cert.id}">
					<input type="file" name="list[${status.index}].imgfile"  class="form-control" >
	            <br>
	            <img src="${APP_PATH }/img/pic.jpg" style="width: 150px;height: 150px">
		  	</div>
		  </c:forEach>
        ...
        <div class="container" style="margin-top:20px;">
            <div class="row clearfix">
                <div class="col-md-12 column">
                    <div id="footer">
                        <div class="footerNav">
                             <a rel="nofollow" href="http://www.drper.cn">关于我们</a> | <a rel="nofollow" href="http://www.atguigu.com">服务条款</a> | <a rel="nofollow" href="http://www.atguigu.com">免责声明</a> | <a rel="nofollow" href="http://www.atguigu.com">网站地图</a> | <a rel="nofollow" href="http://www.atguigu.com">联系我们</a>
                        </div>
                        <div class="copyRight">
